...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 4; i++) {
            String[] PM1 = getColumn2dArray(testPlainMessage, 0);
            System.out.println(PM1[0]);
            System.out.println(PM1[1]);
            System.out.println(PM1[2]);
            System.out.println(PM1[3]);
        }
    ...
    public static void generateKeySchedule(String[][] testCypherKey){
        for (int i = 4; i < 44; i++) {
            String[] previousFour = new String[4];
            previousFour[0] = testCypherKey[0][i-1];
            previousFour[1] = testCypherKey[1][i-1];
            previousFour[2] = testCypherKey[2][i-1];
            previousFour[3] = testCypherKey[3][i-1];
            ...
            if (i % 4 == 0) {
                previousFour = rotWordTransformation(previousFour);
                /*if (i == 8) {
                ...
                previousFour = subBytesTransformation(previousFour);
            }
            ...
            String[] colBack4 = new String[4];
            colBack4[0] = testCypherKey[0][i-4];
            colBack4[1] = testCypherKey[1][i-4];
            colBack4[2] = testCypherKey[2][i-4];
            colBack4[3] = testCypherKey[3][i-4];
            previousFour = hexXORTransformation(colBack4, previousFour, i);
            ...
            testCypherKey[0][i] = previousFour[0];
            testCypherKey[1][i] = previousFour[1];
            testCypherKey[2][i] = previousFour[2];
            testCypherKey[3][i] = previousFour[3];

        }
    }

    public static String[] rotWordTransformation(String[] arr) {
        String hold = arr[0];
        arr[0] = arr[1];
        arr[1] = arr[2];
        arr[2] = arr[3];
    ...
    public static String[] subBytesTransformation(String[] arr) {
        final String[] SBOX = {
    ...
    public static String[] hexXORTransformation(String[] colBack4 , String[] arr, int x) {
